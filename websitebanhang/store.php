...
//Phân trang
//Tính tổng số bản ghi của bản sản phẩm
$total = mysqli_num_rows($item);
// Thiết lập số bản ghi trên một dòng
$limit = 3;
//Tính số trang
...
//query sử dụng limit
$store = mysqli_query($link,"SELECT * FROM sanpham LIMIT $start,$limit");
